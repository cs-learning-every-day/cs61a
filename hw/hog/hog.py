...
def piggy_points(score):
    ...
    "*** YOUR CODE HERE ***"
    sq_score = score**2
    # return min([int(x) for x in str(sq_score)]) + 3
    lowest_value = sq_score % 10
    sq_score //= 10
    while sq_score > 0:
        if sq_score % 10 < lowest_value:
            lowest_value = sq_score % 10
        sq_score //= 10
...
def more_boar(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    def two_digits(score):
        while score >= 100:
            score //= 10
        return score
    player_score = two_digits(player_score)
    opponent_score = two_digits(opponent_score)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if score - last_score > running_high:
            print('Player {} has reached a new maximum point gain. {} point(s)!'.format(
                who, score-last_score))
